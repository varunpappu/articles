This repository contains a series of articles and configuration examples.
...
- [grafana-k8s-monitoring/](./grafana-k8s-monitoring/)
  ...
  - [alloy-logs/](./grafana-k8s-monitoring/alloy-logs/)
    ...
    - [podLogs/](./grafana-k8s-monitoring/alloy-logs/pod-logs/)
      - [introduction.md](./grafana-k8s-monitoring/alloy-logs/pod-logs/pod-logs.md): Deep dive into Pod-Logs, its configuration, and best practices.
      - [values.yaml](./grafana-k8s-monitoring/alloy-logs/pod-logs/values.yaml): Example configuration for podLogs.
